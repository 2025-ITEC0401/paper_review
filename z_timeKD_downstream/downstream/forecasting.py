...
def parse_args():
    ...
    parser.add_argument("--root_path", type=str, default="../data", help="root path of the data files")
...
def load_data(args):
    ...
    train_set = data_class(flag='train', scale=True, size=[args.seq_len, 0, args.pred_len], data_path=args.data_path, root_path=args.root_path, target=args.target)
    val_set = data_class(flag='val', scale=True, size=[args.seq_len, 0, args.pred_len], data_path=args.data_path, root_path=args.root_path, target=args.target)
    test_set = data_class(flag='test', scale=True, size=[args.seq_len, 0, args.pred_len], data_path=args.data_path, root_path=args.root_path, target=args.target)
