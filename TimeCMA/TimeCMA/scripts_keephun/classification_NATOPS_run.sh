...
/hdd/conda_envs/envs/TimeCMA/bin/python downstream_classification.py \
  ...
  --e_layer 1 \
  --d_layer 2 \
  --checkpoint "/hdd/intern/keephun/TimeCMA/logs/2025-12-04-00:04:16-/NATOPS_m/96_64_1_2_0.0001_0.7_2024/best_model.pth" \
  --classifier svm \
  --target_col OT \
  --feature_type latent \
  --output_dir "./Results/classification_comparison/NATOPS_m/" \
  --device cuda:1
